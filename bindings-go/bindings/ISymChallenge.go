...
// VerificationContextLibRawContext is an auto generated low-level Go binding around an user-defined struct.
type VerificationContextLibRawContext struct {
	EncodedTx        []byte
	L2BlockCoinbase  common.Address
	L2BlockNumber    *big.Int
	L2BlockTimestamp *big.Int
}
...
func bindISymChallenge(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := ISymChallengeMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x638068db.
//
// Solidity: function verifyOneStepProof(bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeTransactor) VerifyOneStepProof(opts *bind.TransactOpts, oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextLibRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.contract.Transact(opts, "verifyOneStepProof", oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x638068db.
//
// Solidity: function verifyOneStepProof(bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeSession) VerifyOneStepProof(oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextLibRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.Contract.VerifyOneStepProof(&_ISymChallenge.TransactOpts, oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x638068db.
//
// Solidity: function verifyOneStepProof(bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeTransactorSession) VerifyOneStepProof(oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextLibRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.Contract.VerifyOneStepProof(&_ISymChallenge.TransactOpts, oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}
