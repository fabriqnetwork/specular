...
import (
	...
	"github.com/specularL2/specular/services/sidecar/rollup/services/indexer"
	"github.com/specularL2/specular/services/sidecar/rollup/services/sequencer"
...
func CreateDisseminator(
	...
	return createDisseminator(ctx, cfg, accountMgr)
}
...
func CreateValidator(
	...
	return createValidator(ctx, cfg, accountMgr)
}
