    ...
    stages {
        ...
        steps {
            dir('charts/specular') {
                ...
                discordSend description: "Jenkins Pipeline Build Test *IGNORE*", footer: "Current release is $GIT_COMMIT", link: env.BUILD_URL, result: currentBuild.currentResult, title: JOB_NAME, webhookURL: "https://discord.com/api/webhooks/1219404082184196147/C70F8jtuyODjExk-Xk7hWOaxY-IBQefDumqbTJYlKdOMt2uzmA4ehS3uaO28SwuGgzwi"
