...
// 	opponentAssertion      *assertion.Assertion
// 	ourAssertion           *assertion.Assertion
// 	lastValidatedAssertion *assertion.Assertion
// }
...
// 	challengeResolutionCh chan *assertion.Assertion
// }

// func New(
// 	eth services.ExecutionBackend,
// 	proofBackend proof.Backend,
...
// func (v *ValidatorLegacy) tryValidateAssertion(lastValidatedAssertion, assertion *assertion.Assertion) error {
...
// func (v *ValidatorLegacy) validationLoop(ctx context.Context) {
// 	defer v.Wg.Done()
...
// 	var currentAssertion *assertion.Assertion
...
// func (v *ValidatorLegacy) challengeLoop(ctx context.Context) {
// 	defer v.Wg.Done()
...
// func (v *ValidatorLegacy) APIs() []rpc.API {
// 	// TODO: validator APIs
// 	return []rpc.API{}
// }
