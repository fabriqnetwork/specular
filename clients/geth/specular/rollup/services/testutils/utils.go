...
func (c L1Client) HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error) {
	return c.cfg.HeaderByNumber(ctx, number)
}

// func (c *L1Client) BalanceAt(ctx context.Context, account common.Address, blockNumber *big.Int) (*big.Int, error) {
// 	return c.cfg.BalanceAt(ctx, account, blockNumber)
// }
