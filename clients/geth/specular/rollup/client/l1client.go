...
type L1BridgeClient interface {
	...
	FilterBisected(opts *bind.FilterOpts) (*bindings.IChallengeBisectedIterator, error)
	FilterChallengeCompleted(opts *bind.FilterOpts) (*bindings.IChallengeChallengeCompletedIterator, error)
...
func (c *EthBridgeClient) FilterBisected(opts *bind.FilterOpts) (*bindings.IChallengeBisectedIterator, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
...
func (c *EthBridgeClient) FilterChallengeCompleted(
	opts *bind.FilterOpts,
) (*bindings.IChallengeChallengeCompletedIterator, error) {
	c.mu.Lock()
	defer c.mu.Unlock()
	return c.challenge.Contract.FilterChallengeCompleted(opts)
}
