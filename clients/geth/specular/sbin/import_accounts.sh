...
. $SBIN/configure.sh
cd $DATA_DIR
../build/bin/geth --password ./password.txt --datadir ./data_sequencer account import ./keys/sequencer.prv
../build/bin/geth --password ./password.txt --datadir ./data_sequencer account import ./keys/validator.prv
