...
// VerificationContextRawContext is an auto generated low-level Go binding around an user-defined struct.
type VerificationContextRawContext struct {
	EncodedTx []byte
...
// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x7410d96d.
//
// Solidity: function verifyOneStepProof(uint8 verifier, bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeTransactor) VerifyOneStepProof(opts *bind.TransactOpts, verifier uint8, oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.contract.Transact(opts, "verifyOneStepProof", verifier, oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x7410d96d.
//
// Solidity: function verifyOneStepProof(uint8 verifier, bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeSession) VerifyOneStepProof(verifier uint8, oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.Contract.VerifyOneStepProof(&_ISymChallenge.TransactOpts, verifier, oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}

// VerifyOneStepProof is a paid mutator transaction binding the contract method 0x7410d96d.
//
// Solidity: function verifyOneStepProof(uint8 verifier, bytes oneStepProof, bytes txInclusionProof, (bytes,address,uint256,uint256) ctx, uint256 challengedStepIndex, bytes32[] prevBisection, uint256 prevChallengedSegmentStart, uint256 prevChallengedSegmentLength) returns()
func (_ISymChallenge *ISymChallengeTransactorSession) VerifyOneStepProof(verifier uint8, oneStepProof []byte, txInclusionProof []byte, ctx VerificationContextRawContext, challengedStepIndex *big.Int, prevBisection [][32]byte, prevChallengedSegmentStart *big.Int, prevChallengedSegmentLength *big.Int) (*types.Transaction, error) {
	return _ISymChallenge.Contract.VerifyOneStepProof(&_ISymChallenge.TransactOpts, verifier, oneStepProof, txInclusionProof, ctx, challengedStepIndex, prevBisection, prevChallengedSegmentStart, prevChallengedSegmentLength)
}
